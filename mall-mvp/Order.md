...
订单商品物流：
```
CREATE TABLE `es_express` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `name` varchar(50) NOT NULL DEFAULT '',
  `short_name` varchar(30) NOT NULL DEFAULT '' COMMENT '物流公司简称',
  `full_name` varchar(64) NOT NULL DEFAULT '' COMMENT '物流公司全称',
  `ali_key` varchar(50) NOT NULL DEFAULT '' COMMENT '阿里物流公司编号',
...
CREATE TABLE `es_order_package` (
  ...
  `express_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '快递公司ID，关联es_express表id',
