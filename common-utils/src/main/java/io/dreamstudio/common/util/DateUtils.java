...
public class DateUtils {
    ...
    public static DateTime setDateTime(int year, int month, int date, int hour, int minute, int second) {
     ...
     * @return
     */
    public static Date addNDay(Date date, long n) {
        Date resultDate = new Date();
        long time = date.getTime() + n * 86400000L;
        resultDate.setTime(time);
        return resultDate;
    }
